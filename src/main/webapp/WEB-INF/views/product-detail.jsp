							...
							<div class="flex-w flex-r-m p-b-10">
								...
								<div class="size-204 respon6-next">
									<div class="rs1-select2 bor8 bg0">
										<select class="js-select2" id="time" name="time" onchange="changeColor()">
											<option>Choose an option</option>
										<c:forEach var="color" items="${ color_map }">
								...
								<div class="size-204 respon6-next">
									<div class="rs1-select2 bor8 bg0">
										<select class="js-select2" id="size" name="time">
											<option>Choose an option</option>
										</select>
										<div class="dropDownSelect2"></div>
									</div>
...
<!-- Link back to Colorlib can't be removed. Template is licensed under CC BY 3.0. -->
	...
	<script type="text/javascript">
		function changeColor() {
			...
			var values = select.options[select.selectedIndex].text;
			
			<c:forEach var="v" items="${ color_map }" >
				var colors = "${ v.key }";
			if (values === String(colors)){
